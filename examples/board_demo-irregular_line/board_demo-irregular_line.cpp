...
int main()
{
	...
	my_board.load_configuration("board_configs/irregular_line_test_cursor_config.txt", "cursor", -1, -1, '*');
	my_board.load_configuration("board_configs/irregular_line_test_x_config.txt", "player 1", -1, -1, '*');
	my_board.load_configuration("board_configs/irregular_line_test_o_config.txt", "player 2", -1, -1, '*');
