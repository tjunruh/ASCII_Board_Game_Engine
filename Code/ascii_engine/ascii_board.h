...
public:
	...
	ASCII_BOARD_API void set_tile(int row, int column, const std::string& value, char ignore_character);
	ASCII_BOARD_API void set_tile(int row, int column, const std::string& value, char ignore_character, const std::vector<format_tools::index_format>& colors);
	ASCII_BOARD_API void set_row(int row, const std::string& value, char ignore_character);
	ASCII_BOARD_API void set_row(int row, const std::string& value, char ignore_character, const std::vector<format_tools::index_format>& colors);
	ASCII_BOARD_API void set_column(int column, const std::string& value, char ignore_character);
	ASCII_BOARD_API void set_column(int column, const std::string& value, char ignore_character, const std::vector<format_tools::index_format>& colors);
	ASCII_BOARD_API void set_all(const std::string& value, char ignore_character);
	ASCII_BOARD_API void set_all(const std::string& value, char ignore_character, const std::vector<format_tools::index_format>& colors);
