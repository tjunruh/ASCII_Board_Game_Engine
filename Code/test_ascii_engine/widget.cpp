...
TEST_F(widget_test, set_get_alignment)
{
	...
	set_get_alignment(local_test_widget, format_tools::left_alignment_keyword, UNDEFINED, "none", true, 1);
	set_get_alignment(local_test_widget, format_tools::center_alignment_keyword, SUCCESS, "widget::set_alignment", false, 2);
	set_get_alignment(local_test_widget, format_tools::center_alignment_keyword, UNDEFINED, "none", true, 3);
	set_get_alignment(local_test_widget, format_tools::right_alignment_keyword, SUCCESS, "widget::set_alignment", false, 4);
	set_get_alignment(local_test_widget, format_tools::right_alignment_keyword, UNDEFINED, "none", true, 5);
	set_get_alignment(local_test_widget, "gibberish", INVALID_VALUE, "widget::set_alignment", false, 6);
	set_get_alignment(local_test_widget, format_tools::right_alignment_keyword, UNDEFINED, "none", true, 7);
	set_get_alignment(local_test_widget, format_tools::center_block_alignment_keyword, SUCCESS, "widget::set_alignment", false, 8);
	set_get_alignment(local_test_widget, format_tools::center_block_alignment_keyword, UNDEFINED, "none", true, 9);
...
TEST_F(widget_test, set_get_border_spacing)
{
	...
	set_get_border_spacing(local_test_widget, 3, 3, 6, 6, UNDEFINED, "none", true, 23);
	set_get_border_spacing(local_test_widget, 0, 0, 0, 0, SUCCESS, "widget::set_border_spacing", false, 24);
	set_get_border_spacing(local_test_widget, 0, 0, 0, 0, UNDEFINED, "none", true, 25);
	status = file_manager::delete_file("widget.log");
	ASSERT_EQ(status, 0);
...
TEST_F(widget_test, set_get_coordinate_width_multiplier_test)
{
	...
	set_get_width_multiplier(local_test_widget, 1.5, "none", UNDEFINED, false, 3);
	delete(local_test_frame);
}
...
TEST_F(widget_test, set_get_spacing_width_multiplier_test)
{
	...
	set_get_spacing_width_multipliers(local_test_widget, 3.25, 0.78, "none", UNDEFINED, false, 5);
	delete(local_test_frame);
}
...
TEST_F(widget_test, set_get_border_spacing_width_multiplier_test)
{
	...
	set_get_border_spacing_width_multipliers(local_test_widget, 1.5, 1.5, "none", UNDEFINED, false, 5);
	...
	set_get_border_spacing_width_multipliers(local_test_widget, 1.5, 1.5, "none", UNDEFINED, false, 7);
	...
	set_get_border_spacing_width_multipliers(local_test_widget, 1.5, 1.5, "none", UNDEFINED, false, 10);
	set_get_spacing_width_multipliers(local_test_widget, 0.5, 0.5, "widget::set_spacing_width_multipliers", SUCCESS, true, 11);
	set_get_border_spacing_width_multipliers(local_test_widget, 0.5, 0.5, "none", UNDEFINED, false, 12);
	...
	set_get_border_spacing_width_multipliers(local_test_widget, 0, 0, "none", UNDEFINED, false, 14);
	delete(local_test_frame);
}
...
TEST_F(widget_test, selectability)
{
	frame* local_test_frame = new frame();
	widget local_test_widget(local_test_frame);
	local_test_widget.set_selectable(true);
