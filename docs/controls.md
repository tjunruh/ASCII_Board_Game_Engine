...
- [int get_key(const std::string& control_name)](#get_key)
- [int load_controls(const std::string& file_path)](#load_controls)
- [int save_controls(const std::string& file_path)](#save_controls)
- [void set_select_keys(const std::vector\<int\>& select_keys)](#set_select_keys)
- [std::vector\<int\> get_select_keys()](#get_select_keys)
- [bool key_in_select_keys(const int key)](#key_in_select_keys)
...
**Parameters:**
1. const std::string& **control_name** - name to be used to identify the ascii code
2. const int **key** - ascii code to be bound to control_name identifier
...
**Parameters:**
1. const std::string& **control_name** - name to have the ascii code unmapped from and then deleted
...
**Parameters:**
1. const std::string& **control_name** - name of the control to retrive the mapped ascii code
...
**Parameters:**
1. const std::string& **file_path** - absolute or relative path to file holding control data
...
**Parameters:**
1. const std::string& **file_path** - absolute or relative path to file that should contain the saved control data
...
**Parameters:**
1. consts std::vector\<int\>& **select_keys** - vector containing selection keys
