...
Parameters:
frame* parent - the frame that the widget should be placed in
std::string special_operation - optional parameter used to define how the widget should be placed in the frame (leaving blank will result in the widget being placed to the right of the last widget, "new line" will result in the widget being placed below on a new line, and "merge" will result in the widget being placed below the last widget but still in the same row)
```
...
Parameters:
std::string alginment - alignment of the widget's text ("left", "right", "center", or "center block")
```
...
Parameters:
int top - number of lines on the top of the widget
int bottom - number of lines on the bottom of the widget
int left - number of spaces on the left of the widget
int right - number of spaces on the right of the widget
```
...
Parameters:
int top - number of lines the border is moved up on the top side of widget
int bottom - number of lines the border is moved down on the bottom side of widget
int left - number of spaces the border is moved left on the left side of widget
int right - number of spaces the border is moved right on the right side of widget
```
...
Parameters:
char border - character that should be used to draw the vertical section of the widget's border
```
...
Parameters:
char border - character that should be used to draw the horizontal section of the widget's border
```
...
Parameters:
char border - character that should be used to draw the corners of the widget's border
```
...
Parameters:
char character - character that should be used to visually highlight the widget
```
...
Parameters:
float left_multiplier - used to determine the width of the widget's left spacing as a percent of the total terminal width (if there is only one widget in a row with left spacing multiplier, widget multiplier, and right spacing multiplier of 1.0, 3.0, and 2.0, there widths would be 1/6, 3/6, and 2/6 of the total terminal width respectively)
float right_multiplier - used to determine the width of the widget's right spacing as a percent of the total terminal width (if there is only one widget in a row with left spacing multiplier, widget multiplier, and right spacing multiplier of 1.0, 3.0, and 2.0, there widths would be 1/6, 3/6, and 2/6 of the total terminal width respectively)
```
...
Parameters:
float left_multiplier - used to determine the width of the widget's left spacing as a percent of the total terminal width (if the board multiplier is half of the spacing multiplier, the side border will be placed half way between the spacing width and the widget)
float right_multiplier - used to determine the width of the widget's right spacing as a percent of the total terminal width (if the board multiplier is half of the spacing multiplier, the side border will be placed half way between the spacing width and the widget)
```
...
Parameters:
const std::string& title - title to be displayed in border above widget
```
...
Parameters:
bool border - draws border around widget if set to true and removes border from widget if set to false
```
...
Parameters:
bool use - width multipliers are used when set to true and constant spacing values are used when set to false
```
...
Parameters:
bool selectable - enables the widget to be selectable by the user if true and disables the widget to be selectable by the user if false
```
...
Parameters:
bool include_spacing - includes border and spacing in the width when set to true
...
Parameters:
bool include_spacing - includes border and spacing in the height when set to true
...
Parameters:
const std::string& file_path - absolute or relative path to file that should have widget debug logs written to
